# Customer terms (short form)

A plain-English starting point for your subscription terms. Send it with your first invoice, or put it on your
website and link it from your sign-up email. **Have a solicitor check it before relying on it.** Items in
[brackets] come from `~/Signals/business.yaml`.

---

**[Brand] subscription terms**

These terms are between [legal name] ("we") and the business subscribing ("you").

1. **The service.** Each week we send you a digest of care services and companies in the areas you subscribe to,
   drawn from the public CQC and Companies House registers. We aim to deliver it every Monday, but can't guarantee
...
4. **Data protection.**
   - When you receive the digest, you become an independent controller of any personal data in it (for example, a
     ...
     - following the contact rule shown for each lead: send marketing email only where it says "email OK";
     - screening phone numbers against TPS/CTPS before calling;
     - identifying yourself and offering an easy opt-out in every marketing message;
     - stopping all contact with anyone who objects, and **telling us within 5 working days** (email the name and ID
